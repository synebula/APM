...
hl.bind(mainMod .. " + F2", hl.dsp.exec_cmd("pkill fcitx5 && fcitx5 -d"))                 -- 重启输入法

------------------------------------------------
-- 控制操作
------------------------------------------------
-- 重复按键会切换/关闭启动器
hl.bind(mainMod .. " + SPACE", hl.dsp.exec_cmd("qs ipc call launcher toggle"))          -- 启动应用
-- hl.bind(mainMod .. " + B", hl.dsp.exec_cmd(fileManager))                                 -- 浏览文件 (已由 $mod, E 打开文件管理器)
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd("qs ipc call launcher toggleRun"))           -- 运行命令
...
-- 窗口切换
hl.bind("ALT + TAB", hl.dsp.exec_cmd("qs ipc call switcher next"))         -- 可视化窗口切换 (Quickshell Switcher)
hl.bind(mainMod .. " + TAB", hl.dsp.window.cycle_next())     -- 切换下一个窗口
hl.bind(mainMod .. " + TAB", hl.dsp.window.bring_to_top())   -- 置顶当前聚焦窗口
